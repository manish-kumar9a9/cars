...
<div class="panel-body">
    <form role="form" id ="form" action="web_request_report_data" method="post">
        <div class="form-group">
            <label for="exampleInputEmail1">Request Report</label>
            <select class="form-control m-bot15" name="user_report">
                    <option value="ALL_REQUESTS">All Requests</option>
                    <option value="ALL_REQUESTS_BY_USER">All Requests by user</option>
                    <option value="ACCEPTED_REQUESTS">Accepted Requests</option>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group custom_date_ranger">
            <label class="control-label">Select Date</label>
                <div class="input-group input-large" data-date="13/07/2013" data-date-format="yyyy/mm/dd">
        ...
        <button type="submit" class="btn btn-info" id = 'submit' onclick="return date_match()">Csv Download</button>
    </form>
