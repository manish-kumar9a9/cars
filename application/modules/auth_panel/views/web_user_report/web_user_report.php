...
<div class="panel-body">
    <form role="form" method="post" action ="web_user_report_data">
        <div class="form-group">
            <label for="exampleInputEmail1">User Report</label>
            <select class="form-control m-bot15" name="user_report">
                    ...
                    <option value="PENDING_VERIFICATION_USERS">Pending Verification Users</option>
                    <option value="NOT_VERIFIED_USERS">Not Verified Users</option>
            </select>
        </div>
        <div class="form-group">
