...
<aside class="profile-info col-lg-9">
      ...
      <?php if(!empty($car_reason)) {
       ?>
        <div class="bio-graph-heading">
          ...
          <?php foreach($car_reason as $reason){
            echo '<li>'.$reason.'</li>';
          }
          ?>
        </ul>
      ...
      <div class="panel-body bio-graph-info">
        ...
        <div class="row">
          <div class="bio-row">
            <p><?php if($car_data['availablity'] ==1){
              echo 'Every day';
      ...
      <?php if($car_data['deliveryOption'] == 0){
      }else{
        ?>
      <div class="panel-body bio-graph-info">
        <h1>Delivery
      ...
      <div class="panel-body bio-graph-info">
        ...
        <div class="row">
          <div class="bio-row">
            <p><span>Insurance Type </span>: <?php if($car_data['insuranceType'] ==1){
                echo 'Standard';
              }else {
                echo 'Full Coverage';
              }
      ...
      <div class="panel-body bio-graph-info">
        ...
        <div class="row">
          <div class="bio-row">
            ...
            <a href="<?php echo $car_data['insurance_file_path']; ?>">file</a>
          </div>
        </div>
      </div>
      <div class="panel-body bio-graph-info">
      ...
      <div class="panel-body bio-graph-info">
			  ...
			  <div class="row img-rounded">
				  ...
				  <div class="bio-row">
					 <img src = "<?php echo $car_images['CarImage_path']; ?>"width="304" height="236" class="img-rounded"></img>
				  </div>
          <?php } ?>
			  </div>
