	...
	<div class="findcar-no-bg bg-333">
        <div class="findcar-inner rental-noti">
            <div class="width-50 float-left">
				<h2 class="text-white no-margin padding-15-0 bg-333"><?php echo $this->lang->line('EXPIRED_BOOKINGS'); ?></h2>
            </div>
					...
					<div class="width-100 rental-noti-box ">
						...
						<div class="width-40 float-left padding-15-0">
							<div class="normal-div width-90 padding-right-15 float-right">
								...
								<ul>
									<li>
										<i class="fa fa-map-marker theme-text-color"></i> <h4 class="no-margin"><span><?php echo $this->lang->line('PICK_UP_LOCATION'); ?></span><br><?php echo $r_data['car_details']['carPickUpLocation']; ?></h4>
										<div class="clr"></div>
								...
								<ul>
									<li>
										<i class="fa fa-map-marker theme-text-color"></i> <h4 class="no-margin"><span><?php echo $this->lang->line('DROP_OFF_LOCATION'); ?></span><br><?php echo $r_data['car_details']['carDropOffLocation']; ?></h4>
										<div class="clr"></div>
								...
								<div class="clr"></div>
								<div class="theme-text-color ralewaybold" ><?php echo $this->lang->line('REQUESTED_BY'); ?></div>
								<ul class="rental-pic">
									<li>
