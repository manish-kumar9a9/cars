...
<body class="wrapper">
	...
	<header class="header">
		<div class="top-menu">
			<div class="top-left">
				<div class="hide-menu">
					<div class="menu">
						...
						<!-- Menu -->
						<ul>
							<li><a class="text-uppercase"  href="<?php echo base_url() ?>index.php/user/find_car"><?php echo $this->lang->line('FIND_A_CAR');?></a></li>
							<?php
			...
			<div class="top-right">
				<ul>
					<li><a href="<?php echo base_url() ?>index.php/user/find_car"><?php echo $this->lang->line('FIND_A_CAR');?></a></li>
					<?php
					if ($this->session->userdata('userId') == "") {
						?>
					...
					if ($this->session->userdata('userId') == "" && $this->router->fetch_class() != "welcome") {
						...
						<li> 
							<div class="top-login">
								...
								<ul>
									<li class="dropdown"> <a href="javascript:void(0)" class="dropbtn" onClick="myFunction()"></a>
