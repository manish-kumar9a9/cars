        ...
        <div class='row margin-top-20'>
            <div class='col-sm-3 col-md-3 margin-top-20'>
                <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li class="active gradient_filter"><a href='<?php echo site_url('request/current_booking') ?>'>Bookings (1)</a></li>
            ...
            <div class="col-sm-9 col-md-9">
                ...
                <div id="filter-bookings" class="col-sm-9 text-right no-padding">
                    <div class="pull-right">
                        ...
                        <div class="open">Open Bookings(100)</div>
                        <div class="completed">Completed(54)</div>
                ...
                <div id="booking_wrapper" class="col-xs-12 no-padding">
                    ...
                    foreach($request_data as $r_data){ ?>
                        <?php include(__DIR__.'/../include/ui_blocks/booking.php'); ?>
                    <?php } ?>
                </div>
