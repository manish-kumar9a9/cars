                ...
                <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarmake" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarmake">Select</span>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdowncarmake">
                                                    ...
                                                    foreach ($car_makers as $cm) {
                                                        ...
                                                        if($cm['id'] == $single_car_data['make']){ ?>
                                                            <script>
                                                                var dropdownscarmake = $('#dropdownscarmake');
                                                                dropdownscarmake.text("<?php echo $cm['name'];?>");
                                                                dropdownscarmake.next().val(<?php echo $cm['id'];?>);
                                                            </script>
                                                        <?php }
                                                    } ?>
                                                </ul>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarcat" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarcat">Select</span>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdowncarcat">
                                                    ...
                                                    foreach ($car_types as $ct) {
                                                        ...
                                                        if($ct['id'] == $single_car_data['type']){ ?>
                                                            <script>
                                                                var dropdownscarcat = $('#dropdownscarcat');
                                                                dropdownscarcat.text("<?php echo $ct['name'];?>");
                                                                dropdownscarcat.next().val(<?php echo $ct['id'];?>);
                                                            </script>
                                                        <?php }
                                                    }
                                                    ?>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarmodel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarmodel">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncaryear" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscaryear">Select</span>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdowncaryear">
                                                    ...
                                                    foreach($car_input_data['car_element_year'] as $car_year ) {
                                                        ...
                                                        if ($car_year == $single_car_data['car_brought_year']) { ?>
                                                            <script>
                                                                var dropdownscaryear = $('#dropdownscaryear');
                                                                dropdownscaryear.text("<?php echo $car_year;?>");
                                                                dropdownscaryear.next().val("<?php echo $car_year;?>");
                                                            </script>
                                                        <?php }
                                                    }
                                                    ?>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarmileage" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarmileage">Select</span>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdowncarmileage">
                                                    ...
                                                    foreach($car_element_mileage as $car_mileage ) {
                                                        ...
                                                        if($car_mileage == $single_car_data['mileage']){ ?>
                                                            <script>
                                                                var dropdownscarmileage = $('#dropdownscarmileage');
                                                                dropdownscarmileage.text("<?php echo $car_mileage;?>");
                                                                dropdownscarmileage.next().val("<?php echo $car_mileage;?>");
                                                            </script>
                                                        <?php }
                                                    } ?>
                                                </ul>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarengine" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarengine">Select</span>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdowncarengine">
                                                    ...
                                                    $carcc = strtolower($single_car_data['cubicCapacity']);
                                                    foreach($car_element_cubic_capacity as $car_enginecc ) {
                                                        echo "<li data-id='".$car_enginecc."'><a href='#'>".$car_enginecc."</a></li>";
                                                        if(strtolower($car_enginecc) == $carcc){ ?>
                                                            <script>
                                                                var dropdownscarengine = $('#dropdownscarengine');
                                                                dropdownscarengine.text("<?php echo $car_enginecc;?>");
                                                                dropdownscarengine.next().val("<?php echo $car_enginecc;?>");
                                                            </script>
                                                        <?php }
                                                    } ?>
                                                </ul>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarfuel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarfuel">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncartransmission" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscartransmission">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarcolor" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarcolor">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncardoors" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscardoors">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarseats" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarseats">Select</span>
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <div class="dropdown">
                                                <button class="btn btn-default dropdown-toggle button white pull-right" type="button" id="dropdowncarairbags" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span id="dropdownscarairbags">Select</span>
                        ...
                        <div class="row margin-top-50">
                            <div class="col-xs-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" style="border:0" rows="4"><?php echo $single_car_data['description']; ?></textarea>
                                </div>
                        ...
                        <div id="availability" class="row margin-top-20">
                            <div class="col-xs-12">
                                ...
                                <label class="col-xs-6 col-sm-4 custom-control custom-radio margin-top">
                                    <input id="avail1" <?php echo ($single_car_data['availablity'] == 1) ? 'checked' : ''; ?> name="availablity" value="1" type="radio" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description"><?php echo $this->lang->line('EVERY_DAY');?> (MON-SUN)</span>
                                </label>
                                <label class="col-xs-6 col-sm-4 custom-control custom-radio margin-top ">
                                    <input id="avail2" <?php echo ($single_car_data['availablity'] == 2) ? 'checked' : ''; ?> name="availablity" value="2" type="radio" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                ...
                                <label class="col-xs-12 col-sm-4 custom-control custom-radio margin-top">
                                    <input id="avail3" <?php echo ($single_car_data['availablity'] == 3) ? 'checked' : ''; ?> name="availablity" value="3" type="radio" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                                ...
                                <label class="col-xs-12 custom-control custom-radio margin-top-10">
                                    <input id="datepicker_array" <?php echo ($single_car_data['availablity'] == 4) ? 'checked' : ''; ?> name="availablity" value="4" type="radio" class="custom-control-input">
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div id="car_delivery" class="row margin-top-20">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <input class="col-xs-12 col-sm-5 button gradient_filter margin-top-20" type='submit' value="<?php echo $this->lang->line('RENT_MY_CAR'); ?>">
                                </div>
                            </div>
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                <span>&euro;</span><input type="text" maxlength="5" name="perdayprice" id="perdayprice" value="210" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-6 no-gutter no-padding">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                km <input type="text" maxlength="5" name="perdaykm" id="perdaykm" value="100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 no-gutter no-padding ">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                <span>&euro;</span><input type="text" maxlength="5" name="perweekprice" id="perweekprice" value="210" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-6 no-gutter no-padding">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                km <input type="text" maxlength="5" name="perweekkm" id="perweekkm" value="100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 no-gutter no-padding ">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                <span>&euro;</span><input type="text" maxlength="5" name="permonthprice" id="permonthprice" value="210" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-6 no-gutter no-padding">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding">
                                            ...
                                            <div class="col-md-12 subtitle">
                                                km <input type="text" maxlength="5" name="permonthkm" id="permonthkm" value="100" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-3 sidebar rental-includes margin-bottom-20">
                        ...
                        <div class="form-group col-xs-10 margin-top-20" style="margin-left: 20px">
                            ...
                            <input type="text" value="<?php echo $single_car_data['carPlateNumber'] ?>" class="center" name="carPlateNumber" placeholder="Enter your plate no.">
                        </div>
                        <div class="form-group col-xs-10 margin-top-20" style="margin-left: 20px">
                            <label class="form-control-label" for="inputexpiry">
                                <?php echo $this->lang->line('INSURANCE_EXPIRY_DATE'); ?>
                            </label>
                            <input type="text" class="datepickerinsurance center" value="<?php echo $single_car_data['insuranceValidTill'] ?>" name="insuranceValidTill">
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $daterangepickerinput.daterangepicker({
                ...
                <?php if ($single_car_data['availablity'] == 4) { ?>
